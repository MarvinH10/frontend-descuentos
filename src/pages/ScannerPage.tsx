  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {error && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-2 mb-4 flex items-center gap-2">
            ...
            <button
              onClick={clearError}
              className="text-red-600 hover:text-red-800 text-xs underline p-0"
            >
              Cerrar
            </button>
          </div>
